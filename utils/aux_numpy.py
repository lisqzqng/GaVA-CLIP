# This script is borrowed from: https://github.com/Xpitfire/iwa/blob/main/misc/aux_numpy.py
# Please refer to their license for more information.
import numpy as np
...
def pinv_with_singular_values(a, num_singular_values=-1, hermitian=False, rcond=1e-1):
    ...
    if num_singular_values == -1: 
        ...
        large = np.zeros_like(s, dtype=bool) #np.bool
